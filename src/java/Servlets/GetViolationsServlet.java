   ...
   String currencySymbol;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String begin = "<!DOCTYPE html5>\n" +
            ...
            "                <label for=\"ID2\">ID:</label><input type=\"text\" id=\"ID2\" name=\"ID\" style=\"width: 300px; margin-right: 100px\">\n" +
            "            </form>\n" +
                       "<form action=\"GetCarRegion\" method=\"GET\" style=\"float: left;\">\n" +
            "                <button type=\"submit\" name =\"GetReg\">Car region by num</button>\n" +
            "            </form>\n" +
            "        </div>\n" +
            "    </body>\n" +
            "</html>\n";
